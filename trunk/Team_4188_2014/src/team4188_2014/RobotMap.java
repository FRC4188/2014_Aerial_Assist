...
public class RobotMap {
    ...
    public static boolean reversedDrive = false;
    ...
    public static DigitalInput gateLatchOut;
    public static DigitalInput gateLatchIn;
...
//    public static DigitalInput shootergateLatch2;
    ...
    public static void init() {
        ...
        try { 
            drivetrainfrontRight = new CANJaguar(14);
        } catch (CANTimeoutException ex) {
            ex.printStackTrace();
        }
        ...
        try { 
            drivetrainrearRight = new CANJaguar(13);
        } catch (CANTimeoutException ex) {
            ex.printStackTrace();
        }
//	
...
//        try { 
//            drivetrainrearRight = new CANJaguar(11);
//        } catch (CANTimeoutException ex) {
//            ex.printStackTrace();
//        }
//              
...
//                
//        try { 
//            drivetrainrearLeft = new CANJaguar(15);
//        } catch (CANTimeoutException ex) {
//            ex.printStackTrace();
//        }
//	
//        
//        try { 
//            drivetrainfrontLeft = new CANJaguar(16);
//        } catch (CANTimeoutException ex) {
//            ex.printStackTrace();
//        }
//	   
	...
	LiveWindow.addSensor("Drivetrain", "gyro", drivetraingyro);
        ...
        drivetrainfrontLeftEncoder = new Encoder(1, 7, 1, 8, false, EncodingType.k4X);
//	LiveWindow.addSensor("Drivetrain", "frontLeftEncoder", drivetrainfrontLeftEncoder);
        ...
        drivetrainfrontRightEncoder = new Encoder(1, 5, 1, 6, true, EncodingType.k4X);
//	LiveWindow.addSensor("Drivetrain", "frontRightEncoder", drivetrainfrontRightEncoder);
        ...
        drivetrainrearLeftEncoder = new Encoder(1, 3, 1, 4, false, EncodingType.k4X);
//	LiveWindow.addSensor("Drivetrain", "rearLeftEncoder", drivetrainrearLeftEncoder);
        ...
        drivetrainrearRightEncoder = new Encoder(1, 1, 1, 2, true, EncodingType.k4X);
//	LiveWindow.addSensor("Drivetrain", "rearRightEncoder", drivetrainrearRightEncoder);
 ...
 //       gateLatchOut = new DigitalInput(1, 1);
 //       gateLatchIn = new DigitalInput(1, 2);
