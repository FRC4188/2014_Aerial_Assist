...
//         gyroTOLERANCE = 0.3;         // 0.2778% error ~= 0.5 degrees...?
    ...
    public void init(){   
        gyro.reset();
        rearLeftEncoder.setDistancePerPulse(1.0);
        rearRightEncoder.setDistancePerPulse(1.0);
     ...
     public void resetGyro() 
    {
     ...
     public void getEncoderValues(){        
            ...
            SmartDashboard.putNumber("rearLeftEncoder distance", rearLeftEncoder.getDistance());
            SmartDashboard.putNumber("rearRightEncoder distance", rearRightEncoder.getDistance());
     }
     ...
     public double getPressureVoltage(){
         double press = 45.716*(pressure.getVoltage()) - 12.655;
         return press;
     }
